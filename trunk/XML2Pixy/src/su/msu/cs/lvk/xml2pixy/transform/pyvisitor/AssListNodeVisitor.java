        ...
        for (PythonNode child : assList.getNodes()) {
            if (child.getPhpNode() != null && (child instanceof AssListNode || child instanceof AssNameNode)) {
                ...
                if (child instanceof AssListNode) {
                    helper.addChild(assListElem, helper.create(PhpSymbols.T_LIST, "list", child.getLineno()))
                            .addChild(helper.create(PhpSymbols.T_OPEN_BRACES, "(", child.getLineno()))
                            .addChild(child.getPhpNode())
                            .addChild(helper.create(PhpSymbols.T_CLOSE_BRACES, ")", child.getLineno()));
                } else {
