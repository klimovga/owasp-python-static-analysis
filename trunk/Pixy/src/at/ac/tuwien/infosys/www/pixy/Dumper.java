...
//  dump(LatticeElement) ************************************************************
    ...
    throws IOException {
        ...
        } else if (elementX instanceof TypeLatticeElement) {

            TypeLatticeElement element = (TypeLatticeElement) elementX;

            for (Map.Entry<Variable, Set<Type>> entry : element.getVar2Type().entrySet()) {
