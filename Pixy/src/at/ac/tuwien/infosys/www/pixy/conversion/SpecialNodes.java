...
class SpecialNodes {
    ...
    protected static Logger log = Logger.getLogger(SpecialNodes.class.getName());
    ...
    static CfgNode get(String marker, TacFunction function, TacConverter tac) {
        ...
        if (marker.startsWith("_test_")) {
            ...
            log.error("Unkown marker: " + marker);
            throw new RuntimeException("SNH: unknown marker " + marker);
        }
        return retMe;
    }
