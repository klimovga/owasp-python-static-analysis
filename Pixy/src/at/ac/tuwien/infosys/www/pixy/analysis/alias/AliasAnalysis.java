...
public class AliasAnalysis extends InterAnalysis {
    ...
    protected static Logger log = Logger.getLogger(AliasAnalysis.class.getName());
    ...
    protected TransferFunction global(CfgNode cfgNodeX) {
        ...
        if (realGlobal == null) {
            ...
            */
            ...
            log.warn("Warning: access to non-existent global " + globalOp.getName());
...
//  ********************************************************************************
    ...
    public Set getMustAliases(Variable var, CfgNode cfgNode) {
        ...
        if (aNode == null) {
            log.error("InterAnalysisNode has unexpected null value");
